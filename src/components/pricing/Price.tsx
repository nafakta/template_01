          ...
          <div className="it-pricing-5__title-wrap">
            <div className="row">
              <div className="col-xl-12">
                <div className="it-pricing-5__box text-center">
                  <div className="it-pricing-5__section-box pb-30">
                    <span className="it-section-subtitle-3">OUR PRICING PLANS</span>
                    <h4 className="it-section-title">Select a Plan According to <br />
                  ...
                  <div className="it-pricing-5__tab">
                    <ul className="nav nav-tab justify-content-center" id="myTab" role="tablist">
                      <li className="nav-items" role="presentation">
                        <button className="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Bill Monthly</button>
                      </li>
                      <li className="nav-items" role="presentation">
                        <button className="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Bill Annually</button>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
                    ...
                    <a className="it-grey-btn-2 hover-2" href=""><span>CHOOSE A PLAN</span></a>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item z-index fix p-relative active">
                    ...
                    <a className="it-btn" href="#"><span>CHOOSE A PLAN</span></a>
                  </div>
                </div>
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
              ...
              <div className="row">
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
                    ...
                    <div className="it-pricing-5__middle-box mb-35">
                      <span><strong>$720</strong> / Monthly</span>
                    </div>
                    <div className="it-pricing-5__list mb-30">
                      <ul>
                        <li>Remote support</li>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item z-index fix p-relative active">
                    ...
                    <div className="it-pricing-5__middle-box mb-35">
                      <span><strong>$513</strong> / Monthly</span>
                    </div>
                    <div className="it-pricing-5__list mb-30">
                      <ul>
                        <li>Remote support</li>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div className="it-pricing-5__item">
                    ...
                    <div className="it-pricing-5__middle-box mb-35">
                      <span><strong>$523</strong> / Monthly</span>
                    </div>
                    <div className="it-pricing-5__list mb-30">
                      <ul>
                        <li>Remote support</li>
